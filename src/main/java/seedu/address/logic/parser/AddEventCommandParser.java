...
public class AddEventCommandParser implements Parser<AddEventCommand> {
    ...
    public AddEventCommand parse(String args) throws ParseException {
        ...
        if (!arePrefixesPresent(argMultimap, PREFIX_EVENT_NAME, PREFIX_START, PREFIX_END, PREFIX_DESC)
        ...
        Event event = new Event(name, start, end, argMultimap.getValue(PREFIX_DESC).get());
